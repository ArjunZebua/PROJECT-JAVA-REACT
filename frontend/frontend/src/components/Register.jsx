...
const Register = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      // Payload sesuai dengan model User di backend (username, password, email)
      const payload = { 
        username: formData.username, 
        email: formData.email, 
        password: formData.password
        // role tidak dikirim karena backend belum mendukung
      };
      ...
      const possibleUrls = [
        '/api/auth/register',           // Jika backend dan frontend same domain
        'http://localhost:8080/api/auth/register',  // Spring Boot default port
        'http://localhost:8081/api/auth/register',  // Alternative port
        '/api/register'                 // Original endpoint
      ];
      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-8">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                ...
                <span className="text-xs text-gray-500">Learn Courses</span>
              </button>
          ...
          >
            {isLoading ? (
              ...
              `Create ${formData.role === 'admin' ? 'Admin' : 'Student'} Account`
            )}
          </button>
        </div>
        ...
        <div className="mt-6 p-4 bg-gray-50 rounded-lg">
          ...
          <div className="text-xs text-gray-600 space-y-1">
            <p>Register URL: <code>/api/auth/register</code></p>
